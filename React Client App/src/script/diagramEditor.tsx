...
function renderPeerBadges(): void {
    ...
    peerSelections.forEach((peer) => {
        ...
        const strokeColor = getUserColor(peer.userName);
        ...
        outlineRect.setAttribute('stroke', strokeColor);
        ...
        if (!isNaN(peerUserId)) {
            ...
            badgeContainer.style.backgroundColor = strokeColor;
    ...
    function peerSelectionChanged(selectionEvent: SelectionEvent | null): void {
        if (!diagramRef.current || !selectionEvent || !selectionEvent.userId || !(selectionEvent.elementIds && selectionEvent.elementIds.length)) {
            ...
            peerSelections.forEach((existingPeerSelection, existingPeerConnectionId) => {
                ...
                peerSelections.set(existingPeerConnectionId, { userName: existingPeerSelection.userName, nodeIds: existingPeerSelection.nodeIds, selectorBounds: computedBounds });
            });
        }
        renderPeerBadges();
    }
